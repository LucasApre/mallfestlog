...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-6">
            <label for="" class="text-muted">Data do Requerimento</label>
        ...
        <div class="col-md-6">
            ...
            <div class="ml-3">
                <?php if(isset($status)): ?>
                    <?php if($status == 1): ?>
                    <span class="badge badge-primary rounded-pill px-3">Pendente</span>
                    <?php elseif($status == 2): ?>
                        <span class="badge badge-warning rounded-pill px-3">Em progresso</span>
                    <?php elseif($status == 3): ?>
                        <span class="badge badge-success rounded-pill px-3">Feito</span>
                    <?php elseif($status == 4): ?>
                        <span class="badge badge-danger rounded-pill px-3">Cancelado</span>
                    <?php else: ?>
                        <span class="badge badge-secondary rounded-pill px-3">Pendente</span>
                    <?php endif; ?>
                <?php else: ?>
                    N/A
                <?php endif; ?>
    ...
    <div class="row">
        <div class="col-md-6">
            <label for="" class="text-muted">Nome do veículo</label>
            <div class="ml-3"><b><?= isset($vehicle_name) ? $vehicle_name : "N/A" ?></b></div>
        </div>
        <div class="col-md-6">
            <label for="" class="text-muted">Tipo de Veículo</label>
            <div class="ml-3"><b><?= isset($vehicle_type) ? $vehicle_type : "N/A" ?></b></div>
        </div>
    </div>
    <div class="row">
        <div class="col-md-6">
            <label for="" class="text-muted">Modelo do veículo</label>
    ...
    <div class="row">
        <div class="col-md-12">
            <label for="" class="text-muted">Serviços solicitados</label>
            <div class="ml-3"><b><?= isset($req_ser) ? $req_ser : "N/A" ?></b></div>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
            <label for="" class="text-muted">Mecânico Atribuído</label>
            <div class="ml-3"><b><?= isset($mechanic_id) && isset($mechanic_arr[$mechanic_id]) ? $mechanic_arr[$mechanic_id] : "N/A" ?></b></div>
        </div>
    </div>
    <div class="row">
        <div class="col-md-6">
            <label for="" class="text-muted">Tipo de serviço</label>
        ...
        ?>
        <div class="col-md-6">
            <label for="" class="text-muted">Endereço de retirada</label>
...
<script>
    $('#btn-cancel').click(function(){
        _conf("Tem certeza que deseja cancelar esta solicitação de serviço?","cancel_service",[])
    })

...
<div class="container-fluid">
    ...
    <div class="col-12">
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    <label for="vehicle_type" class="control-label">Tipo de Veículo</label>
                    <input type="text" name="vehicle_type" id="vehicle_type" class="form-control form-control-sm rounded-0" required>
                </div>
                <div class="form-group">
                    <label for="vehicle_name" class="control-label">Nome do veículo</label>
                    <input type="text" name="vehicle_name" id="vehicle_name" class="form-control form-control-sm rounded-0" required>
                </div>
                <div class="form-group">
                    <label for="vehicle_registration_number" class="control-label">Número de registro do veículo</label>
                ...
                <div class="form-group">
                    <label for="vehicle_model" class="control-label">Modelo do veículo</label>
                    <input type="text" name="vehicle_model" id="vehicle_model" class="form-control form-control-sm rounded-0" required>
                </div>
                <div class="form-group">
                    <label for="service_id" class="control-label">Serviços</label>
                ...
                <div class="form-group">
                    <label for="service_type" class="control-label">Tipo de solicitação</label>
                    <select name="service_type" id="service_type" class="form-select form-select-sm select2 rounded-0" required>
                        <option>Daixar</option>
                        <option>Escolher</option>
                    </select>
                </div>
                <div class="form-group" style="display:none">
                    <label for="pickup_address" class="control-label">Endereço de retirada</label>
        ...
        <div class="w-100 d-flex justify-content-end mx-2">
            <div class="col-auto">
                <button class="btn btn-primary btn-sm rounded-0">Enviar pedido</button>
                <button class="btn btn-dark btn-sm rounded-0" type="button" data-dismiss="modal">Fechar</button>
            </div>
        </div>
    </form>
</div>
            ...
            $.ajax({
                ...
                success:function(resp){
                    ...
                    if(resp.status == 'success'){
                        ...
                        alert_toast("Ocoreu um erro",'error');
                    }
                    end_loader()
                }
            })

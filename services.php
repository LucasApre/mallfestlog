 ...
 <header class="bg-dark py-5" id="main-header">
    <div class="container h-100 d-flex align-items-end justify-content-center w-100">
        <div class="text-center text-white w-100">
            ...
            <p class="lead fw-normal text-white-50 mb-0">Cuidamos do seu veículo</p>
            <div class="col-auto mt-2">
                <button class="btn btn-primary btn-lg rounded-0" id="send_request" type="button">Enviar solicitação de serviço</button>
            </div>
        </div>
    </div>
</header>
    ...
    <div class="container px-4 px-lg-5 mt-5">
        <div class="row">
            <div class="col-md-12">
                ...
                <div id="noResult" style="display:none" class="text-center"><b>Sem Resultados</b></div>
            </div>
        </div>
    </div>
</section>
<script>
    $(function(){
        ...
        $('#send_request').click(function(){
            ...
            uni_modal("Preencha o formulário de solicitação de serviço","send_request.php",'mid-large');
            else
            alert_toast("Por favor, faça o login primeiro.","warning");
        })

<div class="content py-5 mt-3">
    <div class="container">
        <h3><b>Minhas solicitações de serviço</b></h3>
        <hr>
                    ...
                    <table class="table table-stripped table-bordered">
                        ...
                        <thead>
                            <tr class="bg-gradient-dark text-light">
                                ...
                                <th class="text-center">Data requerida</th>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button class="btn btn-flat btn-sm btn-default border view_data" type="button" data-id="<?= $row['id'] ?>"><i class="fa fa-eye"></i> Visualizar</button>
                                    </td>
                                </tr>
                            <?php endwhile; ?>
                        </tbody>
...
<script>
    $(function(){
        $('.view_data').click(function(){
            uni_modal("Detalhes da solicitação de serviço","view_request.php?id="+$(this).attr('data-id'),"mid-large")
        })

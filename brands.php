<div class="content py-5 mt-3">
    <div class="container px-4 px-lg-5 mt-5">
        <div class="row">
            <div class="col-md-12">
                <h3 class="text-center">Marcas em nossa loja</h3>
                ...
                <div id="noResult" style="display:none" class="text-center"><b>Sem Resultado</b></div>
            </div>
        </div>
    </div>
</div>
<script>
    $(function(){
        ...
        $('#send_request').click(function(){
            ...
            uni_modal("Preencha o formulário de solicitação de marca","send_request.php",'mid-large');
            else
